module "gwblock" {
  ...
  shared_env = [
    ...
    { name = "GOLOG_LOG_LEVEL", value = "error,p2pnode=debug" },
  ]

  targets = {
    "gw-allow-a" = {
      image       = "147263665150.dkr.ecr.eu-west-1.amazonaws.com/thunderdome:gw-kubo-04e443f76"
      environment = []
    },
    "gw-allow-b" = {
      image       = "147263665150.dkr.ecr.eu-west-1.amazonaws.com/thunderdome:gw-kubo-04e443f76"
    ...
    "gw-deny-a" = {
      image       = "147263665150.dkr.ecr.eu-west-1.amazonaws.com/thunderdome:gw-kubo-e07ca6327-nogateway"
      environment = []
    },
    "gw-deny-b" = {
      image       = "147263665150.dkr.ecr.eu-west-1.amazonaws.com/thunderdome:gw-kubo-e07ca6327-nogateway"
